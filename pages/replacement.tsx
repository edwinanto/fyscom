...
// Logo Imports
import repue1 from '../src/assets/img/catalog/logo_repue/repue1.webp';
import repue2 from '../src/assets/img/catalog/logo_repue/repue2.png';
import repue3 from '../src/assets/img/catalog/logo_repue/repue3.webp';
import repu4 from '../src/assets/img/catalog/logo_repue/repu4.png';
import repue5 from '../src/assets/img/catalog/logo_repue/repue5.png';
import repue6 from '../src/assets/img/catalog/logo_repue/repue6.png';
import repue7 from '../src/assets/img/catalog/logo_repue/repue7.png';
import repue8 from '../src/assets/img/catalog/logo_repue/repue8.png';

const logoList = [repue1, repue2, repue3, repu4, repue5, repue6, repue7, repue8];

// Define product categories and mapping
const categories = [
  { id: 'all', label: 'Todos los Repuestos' },
  { id: 'rodamientos', label: 'Rodamientos y Chumaceras' },
  { id: 'man', label: 'Manómetros' },
];

// Configuration to manually override product titles
// Key: filename without extension (e.g., 'rod1')
// Value: The display title (e.g., 'Rodamiento de Bolas SKF')
const productOverrides: Record<string, string> = {
  ...
  'man4': 'TBM Bimetálico',
  'man5': 'PET/PET-LF',
  'man6': 'PFD Diferencial',
  'man7': 'TSD/THS',
  'man8': 'Bourdon WIKA 111.11',
  'man1': 'WIKA PG81/PG91',
  'rep1': 'Fajas en V',
  'rep10': 'Acoples',
  'rep2': 'Adhesivos',
  'rep3': 'Poleas',
  'rep4': 'Rodamientos',
  'rep5': 'Rodamientos de Precisión',
  'rep6': 'Retenes SKF',
  'rep7': 'Chumaceras',
  'rep8': 'Grasas',
  'rep9': 'Fajas Sincrónicas',
...
const Replacement: React.FC = () => {
  ...
  useEffect(() => {
    // Dynamically load images from src/assets/img/catalog/repuestos
    const modules = import.meta.glob('../src/assets/img/catalog/repuestos/*/*.{png,jpg,jpeg,webp}', { eager: true });
    
    const loadedProducts: Product[] = Object.entries(modules).map(([path, mod]: [string, any]) => {
      // Extract category from path: ../src/assets/img/catalog/repuestos/[category]/[filename]
      const parts = path.split('/');
      const category = parts[parts.length - 2].toLowerCase(); // e.g., 'man', 'rodamientos'
        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
            <div className="max-w-2xl">
              <h2 className="text-header-blue dark:text-white text-4xl sm:text-5xl font-black tracking-tight mb-4">Repuestos Industriales</h2>
              <p className="text-gray-600 dark:text-gray-300 text-lg leading-relaxed">
                Catálogo completo de repuestos y accesorios para el mantenimiento de su maquinaria.
              </p>
            </div>
              ...
              <div key={product.id} className="group relative cursor-pointer overflow-hidden rounded-xl bg-white shadow-sm hover:shadow-xl transition-all duration-300 border border-gray-100">
                ...
                <div className="p-4 bg-white group-hover:hidden border-t border-gray-100">
                  ...
                  <p className="text-gray-500 text-xs truncate">
                    {categories.find(c => c.id === product.category)?.label || 'Repuesto'}
                  </p>
                </div>
              </div>
            ))}
